  ...
  const [appointments,setAppointments] = useState([]);
    useEffect(()=>{
            ...
            try{
                ...
                fetchAllAppointments(); // Call the function when page loads
    ...
    const handleStatusUpdate = async(appId,newStatus)=>{
      try{
        ...
        const presentAppointment = appointments.find((apt) => apt._id === appId);
        ...
        const payload = {
          status: newStatus,
          newDate: newStatus === "Postponed" ? newDate :  presentAppointment.date,
        };

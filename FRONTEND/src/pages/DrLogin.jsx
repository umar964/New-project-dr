...
const DrLogin = () => {
  ...
  const submitHandler = async(e)=>{
    ...
    const drData = {
     ...
     const response = await axios.post(`${import.meta.env.VITE_BASE_URL}/dr/login`,drData);
      ...
      <div className="content">
        ...
        <form onSubmit={submitHandler}  >
          ...
          <div className="sign-up">
            Not a member?
            <Link to="/drsignup">Sign up now</Link>
                
          </div>
        </form>
         <div>
                <button id='drbutton' className="button"><Link to = '/userlogin' id='drlink'>Sign in as user</Link></button>
                </div>
